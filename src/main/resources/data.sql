...
INSERT INTO USER (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (4, 'peter', '$2a$10$VDdIj6vUcp.8lEHKbsOTuuHNoUfIDjJh2fSiOO1.ktTqd74PNSUka', 'peter', 'peter', 'peter@admin.com', 1, PARSEDATETIME('01-01-2016', 'dd-MM-yyyy'));
